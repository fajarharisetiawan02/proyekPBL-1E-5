...
if (isset($_POST['update'])) {
    ...
    mysqli_query($koneksi, "UPDATE perubahan_kelas SET 
        ...
        <div class="main-content">
            ...
            <div class="content-container">
                ...
                <form method="POST" class="form-box">
                    ...
                    <input type="date" name="tanggal_perubahan" value="<?= $row['tanggal_perubahan']; ?>" required>

                    <label>Kelas Asal</label>
                    <input type="text" name="kelas_asal" value="<?= $row['kelas_asal']; ?>" required>

                    <label>Kelas Baru</label>
                    <input type="text" name="kelas_baru" value="<?= $row['kelas_baru']; ?>" required>
